...
const Shop = () => {
    ...
    return ( <
        ...
        li >
        <
        Image className = "displaySneakers"
        src = { displaySneakers }
        alt = "displaySneakers"
        fluid /
        >
        ...
        div className = "shoeItem" >
        <
        Image className = "sideBrownSneakers"
        ...
        div className = "shoeItem" >
        <
        Image className = "limeGreenSports"
        src = { limeGreenSports }
        alt = "limeGreenSports" /
        >
        <
        ...
        div className = "shoeItem" >
        <
        Image className = "lightGreenShoes"
        src = { lightGreenShoes }
        alt = "lightGreenShoes" /
        >
        <
        ...
        div className = "shoeItem" >
        <
        Image className = "flowerLovernBoots"
        ...
        div className = "shoeItem" >
        <
        Image className = "LeopardLetherHeels"
        ...
        div className = "shoeItem" >
        <
        Image className = "StellionKreeHeels"
        src = { StellionKreeHeels }
        alt = "StellionKreeHeels" /
        >
        <
        div className = "darkBanner" >
        <
        ...
        div className = "shoeItem" >
        <
        Image className = "BeigeFormHeels"
        src = { BeigeFormHeels }
        alt = "BeigeFormHeels" /
        >
        <
