...
const Shop = () => {
  ...
  const hideheelsheading = () => setheelsTitle(!heelsTitle)
    ...
    <div className="shopSection">
      ...
      <div className="shop-productsSection">
        <div className="filterList">
          ...
          <button onClick={() => filterType('sneakers'), hideheelsheading()}>Sneakers</button>
          <button onClick={() =>filterType('heels') hideheelsheading()}>Heels</button>
        </div>

        <FilterHeading filterheading="Sneakers" />

        <FilterHeading filterheading="Heels" className={heelsTitle ? "heelsHeading show" : "heelsHeading"} />
