  ...
  return (
    <div className="homeSection">
      <div className="firstpart">
        ...
        <Container className="shoeContainer" fluid>
          <Row className="shoeRow" fluid>
            <Col xs={6} md={4} fluid>
            <Image className="whiteAirs" src={WhiteAirs} alt="whiteAirs" fluid />
            </Col>
            <Col xs={6} md={4} fluid >
            <Image  className="brownSneaker" src={mainhero} alt="mainheroshoe" fluid />

            </Col>
            <Col xs={6} md={4} fluid>
            <Image className="downwardShoe" src={downnWardShoe} alt="downwardshoe" fluid />
            </Col>
          </Row>
        </Container>
