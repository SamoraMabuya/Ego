...
const [currentHeading, setcurrentHeading] = useState(        <FilterHeading filterheading={currentHeading} />
  );
  ...
  return (
    <div className="shopSection">
      ...
      <div className="shop-productsSection">
        ...
        <div className={showHeading ? 'heelsHeading' : 'heelsHeadinghidden'}>Heels</div>
