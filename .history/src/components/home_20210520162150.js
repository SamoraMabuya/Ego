...
const Home = (props) => {
    return ( <
        ...
        Living the dream.A wide variety of shoes
        for everyone. <
        /Col> <
        /Row> <
        /Container>
        ...
        li >
        <
        div className = "secondpart-headline" > “Different occassions require unique shoes”. <
        /div> <
        /li> <
        li >
        <
        ...
        li >
        <
        div className = "thirdpart-headline" > “Boots that make you feel alive”. <
        /div> <
        /li> <
        li >
        <
