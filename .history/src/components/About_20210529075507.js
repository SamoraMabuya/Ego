...
const About = (props) => {
  ...
  return (
    <div>
      <Navbar />
      <Image className="holdingblackheels" src={holdingblackheels} alt="holdingblackheels"/>
      ...
      <Image className="darkblueStellions" src={darkblueStellions} alt="darkblueStellions"/>
